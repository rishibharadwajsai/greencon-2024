...
function MainSection({ title, imgSrc }) {
  return (
    <div className="mt-10 flex flex-col items-center">
      <h1 className=" text-base md:text-3xl font-bold text-center transition-colors first:mt-0 w-[50%] mx-auto text-[#35575a] uppercase tracking-normal">
        {title}
      </h1>
      <div className="mt-2 h-0.5 w-[10%] md:w-[8%] bg-[#35575a] rounded-md"></div>
