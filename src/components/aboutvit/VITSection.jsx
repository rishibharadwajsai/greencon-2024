...
const icons = [
  {
    ...
    image: "/images/icons/education.png",
  },
  {
    name: "Cutting edge Research",
    image: "/images/icons/research.jpeg",
  },
  {
    name: "Impactful People",
    image: "/images/icons/people.avif",
  },
  {
    name: "Rewarding Co-creations",
    image: "/images/icons/reward.jpg",
  },
  {
    name: "Service to Society",
    image: "/images/icons/service.jpg",
  },
];
const VITSection = () => {
  return (
    <section className="py-8 mt-16">
      <div className="container mx-auto text-center">
        ...
        <p className="mt-8 text-lg sm:text-xl text-gray-600 font-bold px-[7%] sm:px-[15%] text-center sm:text-start">
          ...
          VIT was established with the aim to provide quality higher education
          ...
          consistent basis. Established by well-known educationalist and former
          parliamentarian, Dr. G. Viswanathan, Founder and Chancellor, a
          visionary who transformed VIT into a center of excellence in higher
          technical education.
        </p>
        <div className="w-full sm:w-[90%] flex flex-wrap justify-center mt-8 mx-auto">
          {icons.map((person, index) => (
            ...
            >
              ...
              />
              <p className="text-md  text-gray-500">{person.name}</p>
            </div>
          ))}
        </div>
      </div>
