...
const OrganizingCommittee = () => {
  ...
  return (
    <div>
      <h2 className="mt-10 scroll-m-20 border-b border-[#3c5a96] pb-2 text-base md:text-3xl font-bold tracking-tight transition-colors first:mt-0 w-[50%] mx-auto text-[#3c5a96] text-center ">
