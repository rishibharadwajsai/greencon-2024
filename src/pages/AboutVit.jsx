...
const AboutVit = () => {
  return (
    <>
    <div className="w-full flex sm:flex-row flex-col bg-green-50 py-12 pb-20">
        <div className="flex-col w-full sm:w-1/2 justify-center my-auto px-4 mx-auto">
        <img src="/logos/vitlogo-white.jpg" alt="VIT Logo" className="hidden sm:block mx-auto mb-6 w-64 h-auto rounded-xl" />
        <h1 className="scroll-m-20 text-3xl font-extrabold tracking-tight lg:text-4xl text-center px-2 text-[#063032]">
        VELLORE INSTITUTE OF TECHNOLOGY, CHENNAI
      </h1>
      <h3 className="mt-4 scroll-m-20 text-2xl opacity-80 italic tracking-tight text-center text-[#063032]">
